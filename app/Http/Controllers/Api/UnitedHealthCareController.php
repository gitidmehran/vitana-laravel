...
class UnitedHealthCareController extends Controller
{
    protected $per_page = '';
    ...
    {    
        try{
            ...
            $query = UnitedHealthcareCareGaps::where('deleted_at',NULL);
            if(!empty($doctor_id)){
    ...
    public function storeBulkUnitedHealthcareCareGaps(Request $request)
    {
        ...
        try {
                ...
                $lastDataInsert = UnitedHealthcareCareGaps::select('id','created_at')->where('source','like','%CareGap_File%')->where('gap_year', $gap_year)->orderBy('id', 'desc')->first();
                ...
                if ($months >= 3){
                    ...
                    ** Don't forget to add the new gap in this array if new gap is in system database */
                    $constantsCareGaps = Config('constants.caregaps.uhc-001');

                    // checking the records of non excel created gaps to delete when creating the gaps from sheet
                    if ($gap_year == $currentYear) {
                        $currentYearGaps = UnitedHealthcareCareGaps::where('gap_year', $currentYear)->where('source', '!=', 'CareGap_File')->delete();
                    }
                    ...
                    if (!empty($bulktoStoreCareGaps)) {
                        $res = UnitedHealthcareCareGaps::insert($bulktoStoreCareGaps);
                        ...
                        if ($res) {
                            ...
                            $modelInstance = new UnitedHealthcareCareGaps();
                            ...
                            $insertedRows = UnitedHealthcareCareGaps::whereIn('id', $insertedIds)->get();
                        }
                ...
                // $lastDataInsert = UnitedHealthcareCareGaps::select('id','created_at')->where('source','like','%UnitedHealthCareCareGap_File%')->orderBy('id', 'desc')->first();
                ...
                // $valueOfCareGaps = [];
                // $bulktoStoreUnitedHealthcareCareGaps = [];
                // $missedPatients = $missedPatientData = [];
                ...
                //         if (@$value['statin_therapy_gap'] == 'Compliant' && @$value['statin_therapy_gap_current'] != 'Compliant') {
                //             $value['statin_therapy_gap_current'] = 'Compliant';
                //         }
                //         $valueOfCareGaps["statin_therapy_gap"] = @$value['statin_therapy_gap_current'] ?? 'N/A';
                //         $valueOfCareGaps["statin_therapy_gap_insurance"] = @$value['statin_therapy_gap'] ?? 'N/A';
                ...
                //         if (@$value['adults_fun_status_gap'] == 'Compliant' && @$value['adults_fun_status_gap_current'] != 'Compliant') {
                //             $value['adults_fun_status_gap_current'] = 'Compliant';
                //         }
                //         $valueOfCareGaps["adults_fun_status_gap"] = @$value['adults_fun_status_gap_current'] ?? 'N/A';
                //         $valueOfCareGaps["adults_fun_status_gap_insurance"] = @$value['adults_fun_status_gap'] ?? 'N/A';
                ...
                //         if (@$value['med_adherence_diabetes_gap'] == 'Compliant' && @$value['med_adherence_diabetes_gap_current'] != 'Compliant') {
                //             $value['med_adherence_diabetes_gap_current'] = 'Compliant';
                //         }
                //         $valueOfCareGaps["med_adherence_diabetes_gap"] = @$value['med_adherence_diabetes_gap_current'] ?? 'N/A';
                //         $valueOfCareGaps["med_adherence_diabetes_gap_insurance"] = @$value['med_adherence_diabetes_gap'] ?? 'N/A';
                ...
                //         if (@$value['mtm_cmr_gap'] == 'Compliant' && @$value['mtm_cmr_gap_current'] != 'Compliant') {
                //             $value['mtm_cmr_gap_current'] = 'Compliant';
                //         }
                //         $valueOfCareGaps["mtm_cmr_gap"] = @$value['mtm_cmr_gap_current'] ?? 'N/A';
                //         $valueOfCareGaps["mtm_cmr_gap_insurance"] = @$value['mtm_cmr_gap'] ?? 'N/A';
                ...
                //         $valueOfCareGaps["source"]          = 'UnitedHealthCareCareGap_File';
                //         $valueOfCareGaps["created_user"]    = Auth::id();
                ...
                //         $bulktoStoreUnitedHealthcareCareGaps[] = (array)$valueOfCareGaps;
                //     } else {
                //         $missedPatients[] = $missedPatientData;
                //     }
                // }
                
                // if (!empty($bulktoStoreUnitedHealthcareCareGaps)) {
                //     $res = UnitedHealthcareCareGaps::insert($bulktoStoreUnitedHealthcareCareGaps);
                //     $response = [
                //         'success' => true,
                //         'message'=> 'UnitedHealthcareCareGaps Added Successfully And '.$patientConcrollerResponse,
    ...
    public function update(Request $request, $id)
    {
        ...
        $folder_name = '/UnitedHealthcareCareGaps/';//$request->folder_name ?? "";
        ...
        $note = UnitedHealthcareCareGaps::find($id);
        ...
        if ($id != 0) {
            ...
            $gapInsert = UnitedHealthcareCareGaps::create($input121);
        ...
        if ($id==0) {
            $note = UnitedHealthcareCareGaps::find($gapInsert->id);
        }
