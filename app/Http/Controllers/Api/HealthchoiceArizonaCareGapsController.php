...
class HealthchoiceArizonaCareGapsController extends Controller
{
    protected $per_page = '';
    ...
    {    
        try{
            ...
            $query = HealthchoiceArizonaCareGaps::where('deleted_at',NULL);
            if(!empty($doctor_id)){
    ...
    public function storeBulkHealthchoiceArizonaCareGaps(Request $request)
    {
        ...
        try {
                ...
                $lastDataInsert = HealthchoiceArizonaCareGaps::select('id','created_at')->where('source','like','%CareGap_File%')->where('gap_year', $gap_year)->orderBy('id', 'desc')->first();
                ...
                if ($months >= 3){
                    ...
                    ** Don't forget to add the new gap in this array if new gap is in system database */
                    $constantsCareGaps = Config('constants.caregaps.hcarz-001');

                    // checking the records of non excel created gaps to delete when creating the gaps from sheet
                    if ($gap_year == $currentYear) {
                        $currentYearGaps = HealthchoiceArizonaCareGaps::where('gap_year', $currentYear)->where('source', '!=', 'CareGap_File')->delete();
                    }
                    ...
                    if (!empty($bulktoStoreCareGaps)) {
                        $res = HealthchoiceArizonaCareGaps::insert($bulktoStoreCareGaps);
                        ...
                        if ($res) {
                            ...
                            $modelInstance = new HealthchoiceArizonaCareGaps();
                            ...
                            $insertedRows = HealthchoiceArizonaCareGaps::whereIn('id', $insertedIds)->get();
                        }
                        ...
                        $response = array('success'=>true,'message'=> 'CareGaps Added Successfully And '.$patientConcrollerResponse);
                    } else {
                        $response = array('success'=>false, 'scheduled'=> $scheduledAwv, 'message'=>'Duplicate CareGaps found And '.$patientConcrollerResponse);
                    }
                } else {
    ...
    //             $lastDataInsert = HealthchoiceArizonaCareGaps::select('id','created_at')->where('source','like','%HealthchoiceArizonaCareGaps_File%')->orderBy('id', 'desc')->first();
    ...
    //             $valueOfCareGaps = [];
    //             $bulktoStoreHealthchoiceArizonaCareGaps = [];
    //             foreach ($data as $key => $value) {
    //                 $breastCancerGap = $colorectalCancerGap = $bpGap = $EyeExamGap = $HBA1CGap = $statinGap = "N/A";
    ...
    // //2                 
    //                     if (@$value['cervical_cancer_gap'] == 'Compliant' && @$value['cervical_cancer_gap_current'] != 'Compliant') {
    //                         $value['cervical_cancer_gap_current'] = 'Compliant';
    //                     }
    //                     $valueOfCareGaps["cervical_cancer_gap"] = @$value['cervical_cancer_gap_current'] ?? 'N/A';
    //                     $valueOfCareGaps["cervical_cancer_gap_insurance"] = @$value['cervical_cancer_gap'] ?? 'N/A';
    // //3                 
    //                     if (@$value['opioids_high_dosage_gap'] == 'Compliant' && @$value['opioids_high_dosage_gap_current'] != 'Compliant') {
    //                         $value['opioids_high_dosage_gap_current'] = 'Compliant';
    //                     }
    //                     $valueOfCareGaps["opioids_high_dosage_gap"] = @$value['opioids_high_dosage_gap_current'] ?? 'N/A';
    //                     $valueOfCareGaps["opioids_high_dosage_gap_insurance"] = @$value['opioids_high_dosage_gap'] ?? 'N/A';
    // //4
    ...
    // //5
    //                     if (@$value['ppc1_gap'] == 'Compliant' && @$value['ppc1_gap_current'] != 'Compliant') {
    //                         $value['ppc1_gap_current'] = 'Compliant';
    //                     }
    //                     $valueOfCareGaps["ppc1_gap"] = @$value['ppc1_gap_current'] ?? 'N/A';
    //                     $valueOfCareGaps["ppc1_gap_insurance"] = @$value['ppc1_gap'] ?? 'N/A';
    // //6
    //                     if (@$value['ppc2_gap'] == 'Compliant' && @$value['ppc2_gap_current'] != 'Compliant') {
    //                         $value['ppc2_gap_current'] = 'Compliant';
    //                     }
    //                     $valueOfCareGaps["ppc2_gap"] = @$value['ppc2_gap_current'] ?? 'N/A';
    //                     $valueOfCareGaps["ppc2_gap_insurance"] = @$value['ppc2_gap'] ?? 'N/A';
    // //7
    //                     if (@$value['well_child_visits_gap'] == 'Compliant' && @$value['well_child_visits_gap_current'] != 'Compliant') {
    //                         $value['well_child_visits_gap_current'] = 'Compliant';
    //                     }
    //                     $valueOfCareGaps["well_child_visits_gap"] = @$value['well_child_visits_gap_current'] ?? 'N/A';
    //                     $valueOfCareGaps["well_child_visits_gap_insurance"] = @$value['well_child_visits_gap'] ?? 'N/A';
    // //8
    //                     if (@$value['chlamydia_gap'] == 'Compliant' && @$value['chlamydia_gap_current'] != 'Compliant') {
    //                         $value['chlamydia_gap_current'] = 'Compliant';
    //                     }
    //                     $valueOfCareGaps["chlamydia_gap"] = @$value['chlamydia_gap_current'] ?? 'N/A';
    //                     $valueOfCareGaps["chlamydia_gap_insurance"] = @$value['chlamydia_gap'] ?? 'N/A';
    // //9
    ...
    // //10
    //                     if (@$value['fuh_30Day_gap'] == 'Compliant' && @$value['fuh_30Day_gap_current'] != 'Compliant') {
    //                         $value['fuh_30Day_gap_current'] = 'Compliant';
    //                     }
    //                     $valueOfCareGaps["fuh_30Day_gap"] = @$value['fuh_30Day_gap_current'] ?? 'N/A';
    //                     $valueOfCareGaps["fuh_30Day_gap_insurance"] = @$value['fuh_30Day_gap'] ?? 'N/A';
    // //11                    
    //                     if (@$value['fuh_7Day_gap'] == 'Compliant' && @$value['fuh_7Day_gap_current'] != 'Compliant') {
    //                         $value['fuh_7Day_gap_current'] = 'Compliant';
    //                     }
    //                     $valueOfCareGaps["fuh_7Day_gap"] = @$value['fuh_7Day_gap_current'] ?? 'N/A';
    //                     $valueOfCareGaps["fuh_7Day_gap_insurance"] = @$value['fuh_7Day_gap'] ?? 'N/A';
    // //12
    ...
    //                     $valueOfCareGaps["source"]          = 'HealthchoiceArizonaCareGap_File';
    //                     $valueOfCareGaps["created_user"]    = Auth::id();
    ...
    //                     $bulktoStoreHealthchoiceArizonaCareGaps[] = (array)$valueOfCareGaps;
    //                 } else {
    //                     $missedPatients[] = $whereClause;
    //                 }
    //             }

    //             if (!empty($bulktoStoreHealthchoiceArizonaCareGaps)) {
    //                 $res = HealthchoiceArizonaCareGaps::insert($bulktoStoreHealthchoiceArizonaCareGaps);
    //                 $response = [
    //                     'success' => true,
    //                     'message'=> 'HealthchoiceArizonaCareGaps Added Successfully And '.$patientConcrollerResponse,
    //                     'duplicate_patients_ids' => $duplicate_patients_ids
    //                 ];
    //                 //$response = array('success'=>true,'message'=> 'HealthchoiceArizonaCareGaps Added Successfully And '.$patientConcrollerResponse);
    ...
    //                 ];
    //                 //$response = array('success'=>false,'message'=>'Duplicate HealthchoiceArizonaCareGaps found And '.$patientConcrollerResponse);
    //             }
            } catch (\Exception $e) {
                $response = array('success'=>false,'message'=>$e->getMessage(), 'line'=>$e->getLine());
            }
    ...
    public function update(Request $request, $id)
    {
        ...
        $folder_name = '/HealthchoiceArizonaCareGaps/';//$request->folder_name ?? "";
        ...
        $note = HealthchoiceArizonaCareGaps::find($id);
        ...
        if ($id != 0) {
            ...
            $gapInsert = HealthchoiceArizonaCareGaps::create($input121);
        ...
        if ($id==0) {
            $note = HealthchoiceArizonaCareGaps::find($gapInsert->id);
        }
