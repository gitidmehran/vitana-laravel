...
@php
    ...
    $lastYear = \Carbon\Carbon::now()->subYear()->format('Y');
        ...
        <div class="row mb-5">
            <div class="col-xs-6" style="padding-right:5px">
                ...
                <table style=" width:100%; border: 2px solid; color: black;">
                    <tbody>
                        <tr>
                            <th style="width:50%">Initial</th>
                            <th style="width:40%">Periodic</th>
                            <th style="width: 10%"></th>
                        </tr>
                        <tr>
                            <td>
                                99385 (18-39 years) 
                                <input type="checkbox" class="checkbox-1x"  id="check" name="99385" value="" @if(!empty(@$codes['99385'])) checked
                                    @endif />
                            </td>
                            <td>99395 (18-39 years) </td>
                            <td>
                        ...
                        <tr style="border-bottom: 2px solid #000">
                            <td>
                                 99386 (40-64 years) 
                                <input type="checkbox" class="checkbox-1x" name="99386" value="" @if(!empty(@$codes['99386'])) checked @endif />
                            </td>

                            <td>99396 (40-64 years)</td>
                            <td>
                        ...
                        <tr>
                            <td>WELCOME TO MCR</td>
                            <td>G0402</td>
                            <td>
                                <input type="checkbox" class="checkbox-1x" name="G0402" value="" @if(!empty(@$codes['G0402'])) checked
                                    @endif />
                            </td>
                        </tr>

                        <tr>
                            <td>ANNUAL MCR: INITIAL</td>
                            <td>G0438</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>99497(33)</td>
                            <td>
                                <input type="checkbox" class="checkbox-1x" name="99497(33)" value="" @if(!empty(@$codes['99497(33)']))
                                    checked @endif />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>G0444</td>
                            <td>
                                <input type="checkbox" class="checkbox-1x" name="G0444" value="" @if(!empty(@$codes['G0444'])) checked
                                    @endif />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>G0442</td>
                            <td>
                                <input type="checkbox" class="checkbox-1x" name="G0442" value="" @if(!empty(@$codes['G0442'])) checked
                                    @endif />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>G0446</td>
                            <td>
                                <input type="checkbox" class="checkbox-1x" name="G0446" value="" @if(!empty(@$codes['G0446'])) checked
                                    @endif />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>96160</td>
                            <td>
                                <input type="checkbox" class="checkbox-1x" name="96160" value="" @if(!empty(@$codes['96160'])) checked
                                    @endif />
                            </td>
                        </tr>
                        
                        <tr>
                            <td>Comp Eval w/Exam (Humana)</td>
                            <td>99397</td>
                            <td>
                                <input type="checkbox" class="checkbox-1x" name="99397" value="" @if(!empty(@$codes['99397'])) checked
                                    @endif />
                            </td>
                        </tr>
                    </tbody>
                        ...
                        <td colspan=3 style="border: 2px solid; color: black;">
                            <table width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="70%">No Retinopathy ({{$lastYear}}-{{$currentYear}}) </td>
                                        <td>3072F</td>
                                        <td width="10%">
                                    ...
                                    <tr>
                                        <td width="70%">Dilated Eye Exam (Report Viewed in this calender year) </td>
                                        <td>2022F</td>
                                        <td width="10%">
                            ...
                            <table width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>4010F</td>
                                        <td width="10%">
                                            <input type="checkbox" class="checkbox-1x" name="4010F" value="" @if(!empty(@$codes['4010F']))
                                                checked @endif />
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table width="100%">
                                <tbody>
                                    <tr>
                                        <td>3074F</td>
                                        <td width="10%">
                                            <input type="checkbox" class="checkbox-1x" name="3074F" value="" @if(!empty(@$codes['3074F']))
                                                checked @endif />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>3075F</td>
                                        <td width="10%">
                                            <input type="checkbox" class="checkbox-1x" name="3075F" value="" @if(!empty(@$codes['3075F']))
                                                checked @endif />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>3078F</td>
                                        <td width="10%">
                                            <input type="checkbox" class="checkbox-1x" name="3078F" value="" @if(!empty(@$codes['3078F']))
                                                checked @endif />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>3079F</td>
                                        <td width="10%">
                                            <input type="checkbox" class="checkbox-1x" name="3079F" value="" @if(!empty(@$codes['3079F']))
                                                checked @endif />
                                        </td>
                                    </tr>
                            ...
                            <table width="100%">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>1125F</td>
                                        <td width="10%">
                                            <input type="checkbox" class="checkbox-1x" name="1125F" value="" @if(!empty(@$codes['1125F']))
                                                checked @endif />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>1126F</td>
                                        <td width="10%">
                                            <input type="checkbox" class="checkbox-1x" name="1126F" value="" @if(!empty(@$codes['1126F']))
                                                checked @endif />
                                        </td>
                                    </tr>
                                </tbody>
